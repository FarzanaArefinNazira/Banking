...
<body>
  <div>
    ...
    if(isset($_POST['create'])){
       ...
       $sql="SELECT Customer_Id FROM customer_detalis" and "UPDATE  transaction SET Customer_Id=Customer_Id";
      //if($Balance=$Amount){
       $sql="INSERT INTO transaction(Bank_Name,accn,Deposit) VALUES (?,?,?)" ;
     $stmtinsert=$db->prepare($sql);
    
   $result=$stmtinsert->execute([$Bank_Name,$accn,$Deposit]);

        
             $sql = "UPDATE account_detalis SET Amount = Amount+$Deposit WHERE accn=$accn";  
