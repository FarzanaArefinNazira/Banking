...
<body>
  <div>
    ...
    if(isset($_POST['create'])){
        ...
        $Sql="SELECT Amount FROM emp_tr WHERE Amount=Amount>$Withdraw WHERE acc=$accn";


       
      if('Amount'>$Withdraw){
       $sql="INSERT INTO emp_tr(Bank_Name,accn,Withdraw) VALUES (?,?,?)" ;
     $stmtinsert=$db->prepare($sql);
    
   $result=$stmtinsert->execute([$Bank_Name,$accn,$Withdraw]);
        
             $sql = "UPDATE emp_acc SET Amount = Amount-$Withdraw WHERE accn=$accn";  
...
<html>
    ...
    <body>
        ...
        <form action="empw.php" method="post">
