...
if(empty($_POST["Last_Name"]))
 ...
 if($error_First_Name == '' && $error_Last_Name == '' &&$error_Street == '' &&$error_City == '' &&$error_State== '' &&$error_Mobile_No== '' &&$error_Date == '' &&$error_Email == '' &&$error_National_ID == '' && $error_Password == '')
 {
  ...
  $query = "INSERT INTO customer_detalis (First_Name  , Last_Name,  Street, City, State,  Mobile_No, Date,Email,  National_ID,  Password,user_activation_code, user_email_status, user_otp)
  ...
  WHERE NOT EXISTS (
      SELECT Email FROM customer_detalis WHERE Email = :Email
  ) LIMIT 1
  ";
   ...
   require_once 'PHPMailerAutoload.php';
      ...
      if($mail->Send())
      {
        ...
        header('location:emailverify.php?code='.$user_activation_code);
      }
      else
      {
