...
<body>
  <div>
    ...
    $EMP_Phone=$_POST['EMP_Phone'];
     ...
     $sql="INSERT INTO emp(Emp_Name,EMP_Phone,Emp_Email) VALUES (?,?,?)";
     $stmtinsert=$db->prepare($sql);
     $result=$stmtinsert->execute([$Emp_Name,$EMP_Phone,$Emp_Email]);
     if($result)
     {
    ...
    <form action="add.php" method="post">
      <div class="cointainer">
        ...
        <div  class="col">
         ...
         <label for="EMP_Phone"><b>Employee phone number</b></label>
          <input class="form-control" type="text" name="EMP_Phone" required>
