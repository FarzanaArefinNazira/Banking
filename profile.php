...
$stmt= $con->prepare('SELECT Customer_Id, First_Name, Last_Name,Street,City,State,Mobile_No,Email,National_ID,Password FROM customer_detalis WHERE Customer_Id = ?');


$stmt->bind_param('i', $_SESSION['Customer_Id']);
$stmt->execute();
$stmt->bind_result($Customer_Id,$First_Name,$Last_Name,$Street,$City,$State,$Mobile_No,$Email,$National_ID,$Password);
$stmt->fetch();
$stmt->close();
?>
<!DOCTYPE html>
