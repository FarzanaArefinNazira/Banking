...
if(empty($_POST["Last_Name"]))
 ...
 if($error_First_Name == '' && $error_Last_Name == '' &&$error_Street == '' &&$error_City == '' &&$error_State== '' &&$error_Mobile_No== '' &&$error_Date == '' &&$error_Email == '' &&$error_National_ID == '' && $error_Password == '')
 {
  ...
  $query = "INSERT INTO admin (First_Name  , Last_Name,  Street, City, State,  Mobile_No, Date,Email,  National_ID,  Password,user_activation_code, user_email_status, user_otp)
  ...
  ";
   ...
   require_once 'PHPMailerAutoload.php';
      ...
      if($mail->Send())
      {
        ...
        header('location:ademailv.php?code='.$user_activation_code);
      }
      else
      {
